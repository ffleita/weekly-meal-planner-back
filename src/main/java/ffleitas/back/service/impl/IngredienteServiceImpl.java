...
public class IngredienteServiceImpl implements IngredienteService
{
	...
	public IngredientesResponse getAllIngredients()
	{
		...
		return new IngredientesResponse(HttpStatus.OK.toString(),
				IngredienteMapper.allToIngredienteDTO(getIngredientesRepository().findAllNotDeleted()), "");
	}
	...
	public IngredienteCreadoResponse createIngredient(CrearIngredienteRequest request)
	{
		...
		try
		{
			Ingrediente ingrediente = Ingrediente.builder().nombre(request.nombre()).build();
